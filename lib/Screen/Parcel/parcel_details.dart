...
class ParcelDetails extends StatefulWidget {
  ...
  const ParcelDetails({super.key, required this.parcel, this.id});
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Center(child: Text('details'.tr, style: TextStyle(color: statusActive == 1 ? Colors.white : kMainColor))),
                            ),
                          ),
                          Gap(8),
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: statusActive == 2
                                  ? BoxDecoration(color: kMainColor, borderRadius: BorderRadius.circular(40))
                                  : BoxDecoration(
                                      color: Colors.white,
                                      borderRadius: BorderRadius.circular(40),
                                      border: Border.fromBorderSide(
                              ...
                              child: Center(
                                child: Text(
                                  'parcel_log'.tr,
                                  style: TextStyle(
                                    color: statusActive == 2 ? Colors.white : kMainColor,
                                  ),
                                ),
                              ),
                            ),
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      const Spacer(),
                                      Text(
                                        '${Get.find<GlobalController>().currency!}${(double.parse(widget.parcel.totalDeliveryAmount.toString()) - double.parse(widget.parcel.codAmount.toString())).toStringAsFixed(2)}',
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      const Spacer(),
                                      Text(
                                        '${Get.find<GlobalController>().currency!}${widget.parcel.codAmount}',
                                        style: kTextStyle.copyWith(color: kGreyTextColor),
                                      ),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      const Spacer(),
                                      Text(
                                        '${Get.find<GlobalController>().currency!}${widget.parcel.cashCollection}',
                                        style: kTextStyle.copyWith(color: kGreyTextColor, fontWeight: FontWeight.bold),
                                      ),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      const Spacer(),
                                      Text(
                                        '${Get.find<GlobalController>().currency!}${widget.parcel.currentPayable}',
                                        style: kTextStyle.copyWith(color: kGreyTextColor),
                                      ),
                                    ],
                                  ),
