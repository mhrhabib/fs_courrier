                                  ...
                                  child: SizedBox(
                                    child: Column(
                                      children: [
                                            ...
                                            : Row(
                                                ...
                                                children: [
                                                  ...
                                                  ProfileCard(
                                                    ...
                                                    amount: ' ${Get.find<GlobalController>().currency!}${profile.profileMerchant.openingBalance.toString()}',
                                                    imgUrl: Images.logo,
                                                  ...
                                                  ProfileCard(
                                                    page: true,
                                                    topic: '${'vat'.tr}%',
                                                    amount: ' ${Get.find<GlobalController>().currency!}${profile.profileMerchant.vat.toString()}',
                                                    imgUrl: Images.logo,
                                        ...
                                        profileItem(EditProfileView(), Images.iconEditProfile, "edit_profile".tr),
                                        profileItem(ChangePasswordView(), Images.iconChangePass, "change_password".tr),
                                        profileItem(ChangeLanguageView(), Images.iconChangeLang, "change_language".tr),
                                        SizedBox(
                                          height: 14,
                                        ),
                                        InkWell(
