  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'frauds'.tr,
          style: kTextStyle.copyWith(color: kBgColor, fontWeight: FontWeight.bold, fontSize: 18.0),
        ),
        backgroundColor: kMainColor,
        elevation: 0.0,
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        const Spacer(),
                                        const Icon(FontAwesomeIcons.penToSquare, color: kTitleColor, size: 16.0).onTap(
                                          () => EditFrauds(fraud: fraud.fraudList[i]).launch(context),
                                        ),
                                        const SizedBox(width: 20.0),
                                        const Icon(FontAwesomeIcons.trash, color: kTitleColor, size: 16.0).onTap(
                                      ...
                                      children: [
                                        RichText(
                                          text: TextSpan(
                                            ...
                                            style: kTextStyle.copyWith(color: kTitleColor),
                                            children: [
                                              TextSpan(text: ' ${fraud.fraudList[i].phone}', style: kTextStyle.copyWith(color: kTitleColor, fontWeight: FontWeight.bold)),
                                            ],
                                          ),
                                        ),
                                        const Spacer(),
