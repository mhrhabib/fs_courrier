...
class DeliveryChargeList extends StatefulWidget {
  const DeliveryChargeList({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<DeliveryChargeController>(
          ...
          builder: (deliveryCharge) => Container(
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(
                                                          ...
                                                          style: kTextStyle.copyWith(color: kTitleColor, fontSize: 16.0, fontWeight: FontWeight.w900),
                                                        ),
                                                        Text(
                                                          "(${deliveryCharge.deliveryChargesList[i].category})",
                                                          style: kTextStyle.copyWith(color: kGreyTextColor, fontSize: 14.0, fontWeight: FontWeight.w600),
                                                        ),
                                                      ],
                                                    ),
                                                    const Spacer(),
                                                    Container(
                                                      ...
                                                      child: Text(
                                                        ...
                                                        style: kTextStyle.copyWith(fontWeight: FontWeight.w600, fontSize: 13, color: Colors.white),
                                                      ),
                                                    ),
                                                  ],
                                                ),
