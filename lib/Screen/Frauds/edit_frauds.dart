  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<FraudController>(
          ...
          builder: (fraudUpdate) => Stack(children: [
                Center(
                                ...
                                children: [
                                  ...
                                  AppTextField(
                                    ...
                                    controller: fraudUpdate.nameUpdateController
                                      ..text = name.toString()
                                      ..selection = TextSelection.collapsed(offset: fraudUpdate.nameUpdateController.text.length),
                                    showCursor: true,
                                    validator: (value) {
                                  ...
                                  AppTextField(
                                    ...
                                    controller: fraudUpdate.phoneUpdateController
                                      ..text = phone.toString()
                                      ..selection = TextSelection.collapsed(offset: fraudUpdate.phoneUpdateController.text.length),
                                    showCursor: true,
                                    validator: (value) {
                                  ...
                                  AppTextField(
                                    ...
                                    controller: fraudUpdate.trackingIDUpdateController
                                      ...
                                      ..selection = TextSelection.collapsed(offset: fraudUpdate.trackingIDUpdateController.text.length),
                                    showCursor: true,
                                    validator: (value) {
                                      return null;
                                    },
                                  ...
                                  TextFormField(
                                    ...
                                    controller: fraudUpdate.detailsUpdateController
                                      ...
                                      ..selection = TextSelection.collapsed(offset: fraudUpdate.detailsUpdateController.text.length),
                                    validator: (value) {
