  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<ShopController>(
          init: ShopController(),
          builder: (shopUpdate) => Stack(children: [
                Center(
                                ...
                                children: [
                                  ...
                                  AppTextField(
                                    ...
                                    controller: shopUpdate.nameUpdateController
                                      ..text = name.toString()
                                      ..selection = TextSelection.collapsed(offset: shopUpdate.nameUpdateController.text.length),
                                    showCursor: true,
                                    validator: (value) {
                                  ...
                                  AppTextField(
                                    ...
                                    controller: shopUpdate.phoneUpdateController
                                      ..text = phone.toString()
                                      ..selection = TextSelection.collapsed(offset: shopUpdate.phoneUpdateController.text.length),
                                    showCursor: true,
                                    validator: (value) {
                                  ...
                                  TextFormField(
                                    ...
                                    controller: shopUpdate.addressUpdateController
                                      ...
                                      ..selection = TextSelection.collapsed(offset: shopUpdate.addressUpdateController.text.length),
                                    validator: (value) {
