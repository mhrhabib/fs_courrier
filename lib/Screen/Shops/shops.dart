              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: kTextStyle.copyWith(color: kDarkWhite, fontWeight: FontWeight.bold),
                  ),
                  Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          const Icon(FontAwesomeIcons.penToSquare, color: kTitleColor, size: 16.0).onTap(
                                                            () => EditShops(shop: shop.shopList[i]).launch(context),
                                                          ),
                                                          const SizedBox(width: 20.0),
                                                          isFsUser
                                                              ? SizedBox.shrink()
                                                              : const Icon(FontAwesomeIcons.trash, color: kDarkWhite, size: 16.0).onTap(
